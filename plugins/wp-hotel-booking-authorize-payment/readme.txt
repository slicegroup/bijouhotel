...
Tags: hotel, booking, hotel booking, reservation, reservations, authorize.net
...
WP Hotel Booking Authorize Payment supports Authorize.Net payment method for WP Hotel Booking plugin.
...
2. Search for 'WP Hotel Booking Authorize Payment'.
3. Activate WP Hotel Booking Authorize Payment from your Plugins page.

**From WordPress.org**
1. Search, select and download WP Hotel Booking Authorize Payment.
...
= 1.7.3 =
+ Fix redirect thank you page after checkout

= 1.7.2 =
+ Update payment booking process

= 1.7.1 =
+ Update redirect thank you page after checkout

= 1.7 =
+ Publish WP Hotel Booking Authorize Payment to Wordpress
