...
$max_adults_search = hb_get_request( 'adults', 0 );
$max_child_search = hb_get_request( 'max_child', 0 );
?>
<?php if ($max_adults_search == $room->capacity &&	$max_child_search == $room->max_child ): ?>
