...
<div id="hotel-booking-search-<?php echo uniqid(); ?>" class="hotel-booking-search">
    ...
    <form autocomplete="off" name="hb-search-form" action="<?php echo hb_get_url(); ?>"
          class="hb-search-form-<?php echo esc_attr( $uniqid ) ?>">
        <ul class="hb-form-table">
            <li class="hb-form-field">
				<?php hb_render_label_shortcode( $atts, 'show_label', __( 'Fecha de LLegada', 'wp-hotel-booking' ), 'true' ); ?>
                <div class="hb-form-field-input hb_input_field">
                    <input type="text" name="check_in_date" id="check_in_date_<?php echo esc_attr( $uniqid ); ?>"
                           ...
                           placeholder="<?php _e( 'Fecha de LLegada', 'wp-hotel-booking' ); ?>" autocomplete="off"/>
                </div>
            </li>

            <li class="hb-form-field">
				<?php hb_render_label_shortcode( $atts, 'show_label', __( 'Fecha de Salida', 'wp-hotel-booking' ), 'true' ); ?>
                <div class="hb-form-field-input hb_input_field">
                    <input type="text" name="check_out_date" id="check_out_date_<?php echo esc_attr( $uniqid ) ?>"
                           ...
                           placeholder="<?php _e( 'Fecha de Salida', 'wp-hotel-booking' ); ?>" autocomplete="off"/>
                </div>
            </li>
