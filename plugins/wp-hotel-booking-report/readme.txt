...
Tags: hotel, booking, hotel booking, reservation, reservations, statistic, report
...
WP Hotel Booking Report supports statistic for WP Hotel Booking plugin.
...
2. Search for 'WP Hotel Booking Report'.
3. Activate WP Hotel Booking Report from your Plugins page.

**From WordPress.org**
1. Search, select and download WP Hotel Booking Report.
...
= 1.7.1 =
+ Publish WP Hotel Booking Report to Wordpress
