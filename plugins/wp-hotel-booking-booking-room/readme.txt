...
WP Hotel Booking Room Plugin - Support booking in single room page for WP Hotel Booking plugin.

== Description ==

**WP Hotel Booking** is a <a href="https://wordpress.org/plugins/wp-hotel-booking/">WordPress Hotel Booking Plugin</a> by ThimPress.

WP Hotel Booking Room supports booking in single room page for WP Hotel Booking plugin.
...
2. Search for 'WP Hotel Booking Room'.
3. Activate WP Hotel Booking Room from your Plugins page.

**From WordPress.org**
1. Search, select and download WP Hotel Booking Booking Room Report.
...
= 1.8.2 =
+ Fix correct date format when checking blocked date.

= 1.8.1 =
+ Disabled the date which was blocked in Checkout field.

= 1.8.0 =
+ Disabled the date which was blocked.

= 1.7.9 =
+ Update tool check override templates

= 1.7.8 =
+ Update option Single Purchase for booking single room popup

= 1.7.7 =
+ Update check room popup notice
